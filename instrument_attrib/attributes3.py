...
class InstrumentAttrib(QtGui.QDialog, Ui_InstrumentAttributesDialog):
    ...
    def reset_dialog(self):
        ...
        self.Chan0LabelEdit.setStyleSheet('background: ;')

        self.Chan0ColourLineEdit.setEnabled(False)
        self.Chan0ColourLineEdit.clear()
        self.Chan0ColourLineEdit.setStyleSheet('background: ;')

        self.PickerButton0.setEnabled(False)
        self.PickerButton0.setStyleSheet('background: ;')
        ...
        self.Chan1LabelEdit.setStyleSheet('background: ;')

        self.Chan1ColourLineEdit.setEnabled(False)
        self.Chan1ColourLineEdit.clear()
        self.Chan1ColourLineEdit.setStyleSheet('background: ;')

        self.PickerButton1.setEnabled(False)
        self.PickerButton1.setStyleSheet('background: ;')
        ...
        self.Chan2LabelEdit.setStyleSheet('background: ;')

        self.Chan2ColourLineEdit.setEnabled(False)
        self.Chan2ColourLineEdit.clear()
        self.Chan2ColourLineEdit.setStyleSheet('background: ;')

        self.PickerButton2.setEnabled(False)
        self.PickerButton2.setStyleSheet('background: ;')
        ...
        self.Chan3LabelEdit.setStyleSheet('background: ;')

        self.Chan3ColourLineEdit.setEnabled(False)
        self.Chan3ColourLineEdit.clear()
        self.Chan3ColourLineEdit.setStyleSheet('background: ;')

        self.PickerButton3.setEnabled(False)
        self.PickerButton3.setStyleSheet('background: ;')
        ...
        self.Chan4LabelEdit.setStyleSheet('background: ;')

        self.Chan4ColourLineEdit.setEnabled(False)
        self.Chan4ColourLineEdit.clear()
        self.Chan4ColourLineEdit.setStyleSheet('background: ;')

        self.PickerButton4.setEnabled(False)
        self.PickerButton4.setStyleSheet('background: ;')
        ...
        self.Chan5LabelEdit.setStyleSheet('background: ;')

        self.Chan5ColourLineEdit.setEnabled(False)
        self.Chan5ColourLineEdit.clear()
        self.Chan5ColourLineEdit.setStyleSheet('background: ;')

        self.PickerButton5.setEnabled(False)
        self.PickerButton5.setStyleSheet('background: ;')
        ...
        self.Chan6LabelEdit.setStyleSheet('background: ;')

        self.Chan6ColourLineEdit.setEnabled(False)
        self.Chan6ColourLineEdit.clear()
        self.Chan6ColourLineEdit.setStyleSheet('background: ;')

        self.PickerButton6.setEnabled(False)
        self.PickerButton6.setStyleSheet('background: ;')
        ...
        self.Chan7LabelEdit.setStyleSheet('background: ;')

        self.Chan7ColourLineEdit.setEnabled(False)
        self.Chan7ColourLineEdit.clear()
        self.Chan7ColourLineEdit.setStyleSheet('background: ;')

        self.PickerButton7.setEnabled(False)
        self.PickerButton7.setStyleSheet('background: ;')
        ...
        self.Chan8LabelEdit.setStyleSheet('background: ;')

        self.Chan8ColourLineEdit.setEnabled(False)
        self.Chan8ColourLineEdit.clear()
        self.Chan8ColourLineEdit.setStyleSheet('background: ;')

        self.PickerButton8.setEnabled(False)
        self.PickerButton8.setStyleSheet('background: ;')
    ...
    def set(self, instrument, instrument_file, user_home):
        ...
        if self.instrument.instrument_staribus_address == '000':
            ...
            self.StarinetAddressLineEdit.setStyleSheet('background: ;')

            self.StarinetPortLineEdit.blockSignals(True)
            self.StarinetPortLineEdit.clear()
            self.StarinetPortLineEdit.setEnabled(False)
            self.StarinetPortLineEdit.setStyleSheet('background: ;')
            ...
            # TODO enable below once we're have working Mag again.
