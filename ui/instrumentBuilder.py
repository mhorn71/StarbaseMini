...
#
# Created: Tue Jul 28 23:21:48 2015
...
class Ui_InstrumentBuilderDialog(object):
    def setupUi(self, InstrumentBuilderDialog):
        InstrumentBuilderDialog.setObjectName(_fromUtf8("InstrumentBuilderDialog"))
        InstrumentBuilderDialog.resize(943, 682)
        InstrumentBuilderDialog.setMinimumSize(QtCore.QSize(811, 682))
        InstrumentBuilderDialog.setMaximumSize(QtCore.QSize(943, 682))
        self.gridLayout = QtGui.QGridLayout(InstrumentBuilderDialog)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.groupBox = QtGui.QGroupBox(InstrumentBuilderDialog)
        ...
        self.instrumentBuilderTabWidget = QtGui.QTabWidget(InstrumentBuilderDialog)
        ...
        self.retranslateUi(InstrumentBuilderDialog)
        self.instrumentBuilderTabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(InstrumentBuilderDialog)

    def retranslateUi(self, InstrumentBuilderDialog):
        InstrumentBuilderDialog.setWindowTitle(_translate("InstrumentBuilderDialog", "Instrument Builder", None))
        self.groupBox.setTitle(_translate("InstrumentBuilderDialog", "Toolbox", None))
        self.createInstrumentPushButton.setText(_translate("InstrumentBuilderDialog", "Create Instrument XML", None))
        self.setTabContentsPushButton.setText(_translate("InstrumentBuilderDialog", "Save Tab Contents", None))
        self.pushButton_10.setText(_translate("InstrumentBuilderDialog", "Add Core Module", None))
        self.enableInstrumentPushButton.setText(_translate("InstrumentBuilderDialog", "Create Instruments Loader", None))
        self.label_4.setText(_translate("InstrumentBuilderDialog", "Starinet Address", None))
        self.label.setText(_translate("InstrumentBuilderDialog", "Identifier", None))
        self.label_5.setText(_translate("InstrumentBuilderDialog", "Starinet Port", None))
        self.label_8.setText(_translate("InstrumentBuilderDialog", "Filename", None))
        self.label_9.setText(_translate("InstrumentBuilderDialog", ".xml", None))
        self.label_3.setText(_translate("InstrumentBuilderDialog", "Staribus Address", None))
        self.label_2.setText(_translate("InstrumentBuilderDialog", "Description", None))
        self.label_6.setText(_translate("InstrumentBuilderDialog", "Number of Channels", None))
        self.label_7.setText(_translate("InstrumentBuilderDialog", "Help", None))
        self.instrumentBuilderTabWidget.setTabText(self.instrumentBuilderTabWidget.indexOf(self.tab), _translate("InstrumentBuilderDialog", "Instrument", None))
        self.label_10.setText(_translate("InstrumentBuilderDialog", "X axis label", None))
        self.label_11.setText(_translate("InstrumentBuilderDialog", "Y axis label", None))
        self.label_12.setText(_translate("InstrumentBuilderDialog", "Y axis scale", None))
        self.label_13.setText(_translate("InstrumentBuilderDialog", "Y axis range", None))
        self.label_33.setText(_translate("InstrumentBuilderDialog", "Min", None))
        self.label_34.setText(_translate("InstrumentBuilderDialog", "Max", None))
        self.label_14.setText(_translate("InstrumentBuilderDialog", "Help", None))
        self.instrumentBuilderTabWidget.setTabText(self.instrumentBuilderTabWidget.indexOf(self.tab_2), _translate("InstrumentBuilderDialog", "Chart", None))
        self.label_24.setText(_translate("InstrumentBuilderDialog", "Channel", None))
        self.label_25.setText(_translate("InstrumentBuilderDialog", "Label", None))
        self.label_26.setText(_translate("InstrumentBuilderDialog", "Hex Colour", None))
        self.label_15.setText(_translate("InstrumentBuilderDialog", "Channel 0", None))
        self.pushButton.setText(_translate("InstrumentBuilderDialog", "Colour Chooser", None))
        self.label_16.setText(_translate("InstrumentBuilderDialog", "Channel 1", None))
        self.pushButton_2.setText(_translate("InstrumentBuilderDialog", "Colour Chooser", None))
        self.label_17.setText(_translate("InstrumentBuilderDialog", "Channel 2", None))
        self.pushButton_3.setText(_translate("InstrumentBuilderDialog", "Colour Chooser", None))
        self.label_18.setText(_translate("InstrumentBuilderDialog", "Channel 3", None))
        self.pushButton_4.setText(_translate("InstrumentBuilderDialog", "Colour Chooser", None))
        self.label_19.setText(_translate("InstrumentBuilderDialog", "Channel 4", None))
        self.pushButton_5.setText(_translate("InstrumentBuilderDialog", "Colour Chooser", None))
        self.label_20.setText(_translate("InstrumentBuilderDialog", "Channel 5", None))
        self.pushButton_6.setText(_translate("InstrumentBuilderDialog", "Colour Chooser", None))
        self.label_21.setText(_translate("InstrumentBuilderDialog", "Channel 6", None))
        self.pushButton_7.setText(_translate("InstrumentBuilderDialog", "Colour Chooser", None))
        self.label_22.setText(_translate("InstrumentBuilderDialog", "Channel 7", None))
        self.pushButton_8.setText(_translate("InstrumentBuilderDialog", "Colour Chooser", None))
        self.label_23.setText(_translate("InstrumentBuilderDialog", "Channel 8", None))
        self.pushButton_9.setText(_translate("InstrumentBuilderDialog", "Colour Chooser", None))
        self.label_27.setText(_translate("InstrumentBuilderDialog", "Help", None))
        self.instrumentBuilderTabWidget.setTabText(self.instrumentBuilderTabWidget.indexOf(self.tab_3), _translate("InstrumentBuilderDialog", "Channel", None))
        self.label_29.setText(_translate("InstrumentBuilderDialog", "False", None))
        self.checkBox_2.setText(_translate("InstrumentBuilderDialog", "Default", None))
        self.label_31.setText(_translate("InstrumentBuilderDialog", "String", None))
        self.label_32.setText(_translate("InstrumentBuilderDialog", "Help", None))
        self.label_28.setText(_translate("InstrumentBuilderDialog", "True", None))
        self.checkBox.setText(_translate("InstrumentBuilderDialog", "Default", None))
        self.label_30.setText(_translate("InstrumentBuilderDialog", "String", None))
        self.instrumentBuilderTabWidget.setTabText(self.instrumentBuilderTabWidget.indexOf(self.tab_4), _translate("InstrumentBuilderDialog", "Boolean", None))
        self.label_35.setText(_translate("InstrumentBuilderDialog", "Identifier", None))
        self.label_36.setText(_translate("InstrumentBuilderDialog", "Description", None))
        self.label_37.setText(_translate("InstrumentBuilderDialog", "Code Base", None))
        self.label_38.setText(_translate("InstrumentBuilderDialog", "Help", None))
        self.instrumentBuilderTabWidget.setTabText(self.instrumentBuilderTabWidget.indexOf(self.tab_5), _translate("InstrumentBuilderDialog", "Plugin", None))
        self.label_39.setText(_translate("InstrumentBuilderDialog", "Identifier", None))
        self.label_40.setText(_translate("InstrumentBuilderDialog", "Command Code", None))
        self.label_41.setText(_translate("InstrumentBuilderDialog", "Command Variant", None))
        self.label_42.setText(_translate("InstrumentBuilderDialog", "Description", None))
        self.label_43.setText(_translate("InstrumentBuilderDialog", "Send to Port", None))
        self.label_44.setText(_translate("InstrumentBuilderDialog", "Blocked Data Command", None))
        self.label_45.setText(_translate("InstrumentBuilderDialog", "Stepped Data Command", None))
        self.groupBox_2.setTitle(_translate("InstrumentBuilderDialog", "Parameter", None))
        self.label_47.setText(_translate("InstrumentBuilderDialog", "Choices", None))
        self.label_48.setText(_translate("InstrumentBuilderDialog", "Regex", None))
        self.label_49.setText(_translate("InstrumentBuilderDialog", "Tooltip", None))
        self.groupBox_3.setTitle(_translate("InstrumentBuilderDialog", "Response", None))
        self.label_51.setText(_translate("InstrumentBuilderDialog", "Data Type Name", None))
        self.label_52.setText(_translate("InstrumentBuilderDialog", "Units", None))
        self.label_53.setText(_translate("InstrumentBuilderDialog", "Regex", None))
        self.label_54.setText(_translate("InstrumentBuilderDialog", "Help", None))
        self.instrumentBuilderTabWidget.setTabText(self.instrumentBuilderTabWidget.indexOf(self.tab_6), _translate("InstrumentBuilderDialog", "Command", None))
        self.instrumentBuilderTabWidget.setTabText(self.instrumentBuilderTabWidget.indexOf(self.tab_7), _translate("InstrumentBuilderDialog", "Help", None))
