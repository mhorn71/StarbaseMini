...
#
# Created: Fri Sep 11 22:51:00 2015
...
class Ui_InstrumentAttributesDialog(object):
    def setupUi(self, InstrumentAttributesDialog):
        ...
        self.Chan0CheckBox = QtGui.QCheckBox(self.groupBox)
        self.Chan0CheckBox.setEnabled(False)
        self.Chan0CheckBox.setText(_fromUtf8(""))
        self.Chan0CheckBox.setObjectName(_fromUtf8("Chan0CheckBox"))
        self.horizontalLayout_4.addWidget(self.Chan0CheckBox)
        ...
        self.Chan1CheckBox = QtGui.QCheckBox(self.groupBox)
        self.Chan1CheckBox.setEnabled(False)
        self.Chan1CheckBox.setText(_fromUtf8(""))
        self.Chan1CheckBox.setObjectName(_fromUtf8("Chan1CheckBox"))
        self.horizontalLayout_5.addWidget(self.Chan1CheckBox)
        ...
        self.Chan2CheckBox = QtGui.QCheckBox(self.groupBox)
        self.Chan2CheckBox.setEnabled(False)
        self.Chan2CheckBox.setText(_fromUtf8(""))
        self.Chan2CheckBox.setObjectName(_fromUtf8("Chan2CheckBox"))
        self.horizontalLayout_6.addWidget(self.Chan2CheckBox)
        ...
        self.Chan3CheckBox = QtGui.QCheckBox(self.groupBox)
        self.Chan3CheckBox.setEnabled(False)
        self.Chan3CheckBox.setText(_fromUtf8(""))
        self.Chan3CheckBox.setObjectName(_fromUtf8("Chan3CheckBox"))
        self.horizontalLayout_7.addWidget(self.Chan3CheckBox)
        ...
        self.Chan4CheckBox = QtGui.QCheckBox(self.groupBox)
        self.Chan4CheckBox.setEnabled(False)
        self.Chan4CheckBox.setText(_fromUtf8(""))
        self.Chan4CheckBox.setObjectName(_fromUtf8("Chan4CheckBox"))
        self.horizontalLayout_8.addWidget(self.Chan4CheckBox)
        ...
        self.Chan5CheckBox = QtGui.QCheckBox(self.groupBox)
        self.Chan5CheckBox.setEnabled(False)
        self.Chan5CheckBox.setText(_fromUtf8(""))
        self.Chan5CheckBox.setObjectName(_fromUtf8("Chan5CheckBox"))
        self.horizontalLayout_9.addWidget(self.Chan5CheckBox)
        ...
        self.Chan6CheckBox = QtGui.QCheckBox(self.groupBox)
        self.Chan6CheckBox.setEnabled(False)
        self.Chan6CheckBox.setText(_fromUtf8(""))
        self.Chan6CheckBox.setObjectName(_fromUtf8("Chan6CheckBox"))
        self.horizontalLayout_10.addWidget(self.Chan6CheckBox)
        ...
        self.Chan7CheckBox = QtGui.QCheckBox(self.groupBox)
        self.Chan7CheckBox.setEnabled(False)
        self.Chan7CheckBox.setText(_fromUtf8(""))
        self.Chan7CheckBox.setObjectName(_fromUtf8("Chan7CheckBox"))
        self.horizontalLayout_11.addWidget(self.Chan7CheckBox)
        ...
        self.Chan8CheckBox = QtGui.QCheckBox(self.groupBox)
        self.Chan8CheckBox.setEnabled(False)
        self.Chan8CheckBox.setText(_fromUtf8(""))
        self.Chan8CheckBox.setObjectName(_fromUtf8("Chan8CheckBox"))
        self.horizontalLayout_12.addWidget(self.Chan8CheckBox)
