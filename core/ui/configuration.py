...
#
# Created: Sat Jul 25 09:29:45 2015
...
class Ui_ConfigurationDialog(object):
    def setupUi(self, ConfigurationDialog):
        ...
        self.widget.setGeometry(QtCore.QRect(10, 40, 259, 29))
        self.widget.setObjectName(_fromUtf8("widget"))
        self.horizontalLayout_31 = QtGui.QHBoxLayout(self.widget)
        self.horizontalLayout_31.setMargin(0)
        self.horizontalLayout_31.setObjectName(_fromUtf8("horizontalLayout_31"))
        self.controllerBaudRateComboBox = QtGui.QComboBox(self.widget)
        self.controllerBaudRateComboBox.setObjectName(_fromUtf8("controllerBaudRateComboBox"))
        self.horizontalLayout_31.addWidget(self.controllerBaudRateComboBox)
        self.controllerBaudrateDefaultCheckBox = QtGui.QCheckBox(self.widget)
        self.controllerBaudrateDefaultCheckBox.setObjectName(_fromUtf8("controllerBaudrateDefaultCheckBox"))
        self.horizontalLayout_31.addWidget(self.controllerBaudrateDefaultCheckBox)
        self.controllerBaudrateSetPushButton = QtGui.QPushButton(self.widget)
        self.controllerBaudrateSetPushButton.setObjectName(_fromUtf8("controllerBaudrateSetPushButton"))
        self.horizontalLayout_31.addWidget(self.controllerBaudrateSetPushButton)
    ...
    def retranslateUi(self, ConfigurationDialog):
        ...
        self.groupBox_4.setTitle(_translate("ConfigurationDialog", "UKRAA (Futurlec) Controller Baudrate Control", None))
        self.controllerBaudrateDefaultCheckBox.setText(_translate("ConfigurationDialog", "Default", None))
        self.controllerBaudrateSetPushButton.setText(_translate("ConfigurationDialog", "Set", None))
